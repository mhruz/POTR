...
from deformable_potr_plus.models.deformable_potr_plus import SetCriterion
...
from deformable_potr_plus.engine import evaluate
...
matcher_prediction = build_matcher(args)
...
criterion = SetCriterion(args.num_classes, matcher_prediction, weight_dict={}, losses={})
criterion.to(device)
...
data_loader_eval = DataLoader(dataset_test, batch_size=args.batch_size, num_workers=0, shuffle=False)
