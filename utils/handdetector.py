...
from util.transformations import rotatePoint2D, rotatePoints2D, rotatePoints3D
...
class HandDetector(object):
    ...
    def getCrop(self, dpt, xstart, xend, ystart, yend, zstart, zend, thresh_z=True, background=0):
        ...
        if thresh_z is True:
            ...
            cropped[msk1] = 0. # original is zstart, but noise
    ...
    def cropArea3D(self, com=None, size=(250, 250, 250), dsize=(128, 128), docom=False):
        ...
        #z nejakeho duvodu zde asi muze byt cropped == []
        if cropped.size == 0:
          cropped = self.dpt.copy()
