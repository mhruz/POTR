...
def get_args_parser():
    ...
    # Parameters: Dataset
    parser.add_argument('--train_data_path', default="/Users/matyasbohacek/Documents/Academics/Datasets/Custom/FAV_Train_Sample/train_image.h5",
                        type=str, help="Path to the training dataset H5 file.")
    parser.add_argument('--eval_data_path', default="/Users/matyasbohacek/Documents/Academics/Datasets/Custom/FAV_Train_Sample/train_image.h5",
